...
class DataFrameHasher:
    def __init__(self, df: DataFrame, cols_to_hash, output_hash_col_name):
        """
    ...
    def hash_rows(self):
        ...
        hashed_df[self.output_hash_col_name] = hashed_df.apply(
            lambda row: self.hash_row(row), axis=1
        )
